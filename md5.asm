...
; As per spec K[i] := floor(2^32 × abs(sin(i + 1)))
K: dd \
...
a0: equ 0x67452301    ; A initial value
b0: equ 0xefcdab89    ; B initial value
c0: equ 0x98badcfe    ; C initial value
d0: equ 0x10325476    ; D initial value
